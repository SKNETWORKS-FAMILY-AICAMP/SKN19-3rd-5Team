...
<img width="1000" height="800" alt="Service Architecture_Simple" src="https://github.com/user-attachments/assets/faf6f405-cde8-4a79-855d-d446d54ecaf0" />
...
## 한줄회고
- **`김소희`**
> 서비스 목적을 중심으로 시스템을 설계하고 테스트하면서, 사용자 시나리오와 LangGraph 구조의 연결이 LLM 서비스의 핵심임을 깨달았습니다. 또한 LLM 평가 지표를 고려한 구조 설계가 결국 실제 사용 가능한 서비스를 만드는 기준이 된다는 것도 배웠습니다. 이를 바탕으로 다음 프로젝트에서는 '사용자 시나리오 중심 LLM 설계'를 더 깊게 확장할 계획입니다.
- **`박준영`**
